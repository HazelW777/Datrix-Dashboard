      ...
      operation: {
        ...
        operationDetails: {
          ...
          ...(config.operationType === "rename_column" && {
            renamedFrom: config.selectedColumns?.[0],
            renamedTo: config.newColumnName,
          }),
          ...(config.operationType === "remove_column" && {
            removedColumns: config.selectedColumns,
          }),
          ...(config.operationType === "combine_column" && {
            combinedColumns: config.combineColumns,
            newColumnName: config.newColumnName,
          }),
          ...(config.operationType === "split_column" && {
            splitColumn: config.splitColumn,
            newColumns: config.splitNewColumns,
          }),
        },
      },
    });
                                        ...
                                        {config.operationType ===
                                          ...
                                          <div className="space-y-3">
                                            ...
                                            <div>
                                              ...
                                              <Input
                                                placeholder="e.g., new_column_name"
                                                value={
                                                  config.newColumnName || ""
                                                }
                                                onChange={(e) =>
